...
<template>
	<div id="kt_app_header" class="app-header bg-light-danger c-sticky-top">
		...
		>
			...
			>
				<div class="app-navbar-item ms-2 ms-lg-4">
					...
					<!--begin::Menu-->
					<div
						class="menu menu-sub menu-sub-dropdown menu-column mt-2 w-300px w-lg-325px"
						data-kt-menu="true"
					>
						<!--begin:Nav-->
			...
			<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
				<a href="/" class="d-lg-none">
					<img
						...
						class="theme-light-showi h-35px mb-3"
					/>
					<!-- <img
								alt="Logo"
			...
			>
					...
					>
						<a href="/" class="d-none d-lg-block">
							<img
								alt="Logo"
								src="/assets/media/logos/logo-default.png"
								class="theme-light-showi h-50px mb-3"
							/>
						</a>
					</h1>
					<!--end::Title-->
				...
				<div class="app-navbar align-items-center flex-shrink-0">
					...
					<div class="app-navbar-item ms-2 ms-lg-4">
						...
						<a
							href="#"
							class="btn btn-custom btn-outline border-gray-500 btn-icon btn-active-icon-primary"
					...
					<div class="app-navbar-item ms-2 ms-lg-4">
						<!--begin::Menu wrapper-->
						<div
							class="btn btn-custom btn-icon symbol"
							data-kt-menu-trigger="click"
							data-kt-menu-attach="parent"
							data-kt-menu-placement="bottom-end"
						>

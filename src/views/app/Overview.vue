	...
	>
		...
		>
			<div class="card-title">
				<h3 class="fw-bold m-0">{{ $t("app.overview.title") }}</h3>
			</div>
		</div>
		<!--end::Card header-->
		...
		<div id="kt_account_settings_overview" class="collapse show">
			...
			<div class="card-body border-top p-9">
					...
					<div class="d-flex flex-stack flex-grow-1">
						...
						<div class="fw-semibold">
							<h4 class="text-gray-900 fw-bold">
								{{ $t("app.overview.notice.title") }}
							</h4>

							<div class="fs-6 text-gray-700">
								{{ $t("app.overview.notice.text") }}
								<a href="#subscription_plans">
									{{ $t("app.overview.notice.link") }}
								</a>
							</div>
						</div>
						<!--end::Content-->
				...
				<div class="mt-4">
					<h1 class="h3 mb-5 mt-4">
						{{ $t("app.overview.mySubscriptions.title") }}
					</h1>
					<div
						v-if="subscriptions.length == 0"
						class="text-center text-muted"
					>
						{{ $t("app.overview.mySubscriptions.noSubscriptions") }}
					</div>

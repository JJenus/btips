      ...
      <div class="card-body border-top p-9">
        <div class="d-flex align-items-start flex-wrap mb-7">
          <div class="d-flex flex-wrap flex-row">
            <!--begin::Avatar-->
            <div class="symbol symbol-125px shadow mb-7 me-7 position-relative">
            ...
            <div class="d-flex flex-column">
              ...
              <div class="d-flex flex-row align-items-center">
                <div v-if="subscriptions.length == 0" class="me-6">
                  <div
                    class="badge badge-light-danger text-danger fw-bold fs-7 me-auto px-4 py-3"
                  >
                    <i class="fa-solid fa-question-circle me-2 text-danger"></i>
                    Not Subscribed
                  </div>
                </div>
                <div>
        ...
        <div class="mt-4">
          ...
          <div v-if="subscriptions.length == 0" class="text-center text-muted">
